...
const Sidebar = ({ isOpen }) => {
  ...
  return (
    <aside className="sidebar-izq" style={{ backgroundColor: '#F6A700', width: isOpen ? '80px' : '0', overflow: 'hidden', transition: 'width 0.3s ease', minHeight: 'calc(100vh - 60px)', position: 'relative' }}>
